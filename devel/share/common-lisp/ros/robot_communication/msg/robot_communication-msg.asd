...
(defsystem "robot_communication-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "ESDFmap" :depends-on ("_package_ESDFmap"))
    (:file "_package_ESDFmap" :depends-on ("_package"))
    ...
    (:file "localizationInfoBroadcast" :depends-on ("_package_localizationInfoBroadcast"))
    (:file "_package_localizationInfoBroadcast" :depends-on ("_package"))
